              ...
              child: Row(children: [
                ...
                Flexible(
                  child: Container(
                      ...
                      decoration: const BoxDecoration(color: Colors.black),
                      child: RTCVideoView(
                          VolunteerCubitSide.get(context).remoteRenderer)),
                )
              ])),
          const SizedBox(
            height: 20.0,
                    ...
                    CircleAvatar(
                      ...
                      child: IconButton(
                        ...
                        icon: Icon(
                          ...
                          color: VolunteerCubitSide.get(context).isMuted
                              ? Colors.red
                              : Colors.white,
                        ),
                      ),
                    ...
                    CircleAvatar(
                      ...
                      child: IconButton(
                        ...
                        icon: Icon(
                          ...
                          color: VolunteerCubitSide.get(context).isDeafened
                              ? Colors.red
                              : Colors.white,
                        ),
                      ),
                    ...
                    CircleAvatar(
                      ...
                      child: IconButton(
                        ...
                        icon: Icon(
                          ...
                          color: VolunteerCubitSide.get(context).isVideoOff
                              ? Colors.red
                              : Colors.white,
                        ),
                      ),
